                    ...
                    () => Wrap(
                      ...
                      children: List.generate(
                        ...
                        (index) => GestureDetector(
                          onTap: () {
                            // ตรวจสอบว่าคุณได้รับการคลิก
                            print('Tapped on color index: $index');
                            ...
                            // พิมพ์ค่า p_colors ออกมา
                            print(
                                'Selected Color Indexes: ${controller.selectedColorIndexes}');
                            print(
                                'Selected Colors: ${controller.selectedColorIndexes.map((i) => controller.allColors[i]).toList()}');
                          },
                          child: Container(
                            width: 40,
                            height: 40,
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color: controller.selectedColorIndexes
                                            .contains(index) ||
                                        controller.allColors.any((color) =>
                                            controller.selectedColorIndexes
                                                .contains(controller.allColors
                                                    .indexOf(color)))
                                    ? Colors
                                        .blue // สีฟ้าสำหรับสีที่ถูกเลือกหรือที่มีอยู่ใน allColors
                                    : greyThin,
                                width: 2,
                              ),
                            ),
